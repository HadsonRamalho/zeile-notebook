...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    description: 'Plataforma baseada em blocos para criação de notebooks interativos. Permite documentação em Markdown e execução de código nativo em ambiente remoto isolado.',
    start_url: '/',
    display: 'standalone',
