...
CREATE INDEX idx_grants_lookup ON permission_grants (permission_key, target_kind, target_id, target_value);
CREATE INDEX idx_grants_subject ON permission_grants (subject_kind, subject_id, subject_principal);
