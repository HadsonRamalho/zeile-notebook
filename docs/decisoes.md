# Zeile — Catálogo de decisões (Q1–Q107)

Registro incremental das decisões de padrão do Zeile. Cada entrada é citável por número em
review (`Q64`), e é a origem dos docs normativos de `docs/architecture/` — quando estes
existirem (etapa 17 do [plano de execução](plano-execucao.md)), passam a ser a redação final.
