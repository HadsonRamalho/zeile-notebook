...
#[utoipa::path(get, path = "/admin/stats", responses((status = OK), (status = 401, body = ApiError)))]
...
#[utoipa::path(get, path = "/admin/users", responses((status = OK), (status = 401, body = ApiError)))]
...
#[utoipa::path(get, path = "/admin/teams", responses((status = OK), (status = 401, body = ApiError)))]
...
#[utoipa::path(get, path = "/admin/search", responses((status = OK), (status = 401, body = ApiError)))]
...
#[utoipa::path(post, path = "/admin/notify", responses((status = CREATED), (status = 401, body = ApiError)))]
...
#[utoipa::path(get, path = "/admin/notebooks", responses((status = OK), (status = 401, body = ApiError)))]
